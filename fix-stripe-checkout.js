/*
 * This script exports the correct code for the stripe-checkout function
 * Copy this code and paste it into your Supabase dashboard:
 * 1. Go to https://supabase.com/dashboard/project/gtxigxwklomqdlihxjyd/functions
 * 2. Click on "stripe-checkout" function
 * 3. Replace ALL code with the code below (everything between START and END markers)
 */
...
// Also ensure the environment variables are set
console.log("\nMake sure these environment variables are set in your Supabase project:");
console.log("- STRIPE_SECRET_KEY: Your Stripe secret key (starts with sk_live_ or sk_test_)");
console.log("- SUBSCRIPTION_PRICE_ID: Your Stripe price ID (starts with price_)");
console.log("- SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY: Should be auto-set by Supabase");
console.log("\nYou can set these in the Supabase dashboard under:");
console.log("Project Settings > API > Edge Functions > Environment Variables"); 